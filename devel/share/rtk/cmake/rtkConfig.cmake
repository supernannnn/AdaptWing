...
if("TRUE" STREQUAL "TRUE")
  set(rtk_SOURCE_PREFIX /home/skbt/AdaptWing/src/location/rtk)
  set(rtk_DEVEL_PREFIX /home/skbt/AdaptWing/devel)
  set(rtk_INSTALL_PREFIX "")
  set(rtk_PREFIX ${rtk_DEVEL_PREFIX})
else()
  set(rtk_SOURCE_PREFIX "")
  set(rtk_DEVEL_PREFIX "")
  set(rtk_INSTALL_PREFIX /home/skbt/AdaptWing/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'skbt <skbt@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rtk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/skbt/AdaptWing/src/location/rtk/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rtk_NUM_DUMMY_TARGETS)
      set(rtk_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rtk::wrapped-linker-option${rtk_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rtk_NUM_DUMMY_TARGETS "${rtk_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rtk::wrapped-linker-option${rtk_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rtk_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/skbt/AdaptWing/devel/lib;/home/skbt/AdaptWing/devel/lib;/home/skbt/BIT-Drone-360/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(rtk_EXPORTED_TARGETS ${${rtk_dep}_EXPORTED_TARGETS})
endforeach()
