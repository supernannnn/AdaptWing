...
if("TRUE" STREQUAL "TRUE")
  set(rtk_SOURCE_PREFIX /home/skbt/BIT-UAV/src/location/rtk)
  set(rtk_DEVEL_PREFIX /home/skbt/BIT-UAV/devel)
  set(rtk_INSTALL_PREFIX "")
  set(rtk_PREFIX ${rtk_DEVEL_PREFIX})
else()
  set(rtk_SOURCE_PREFIX "")
  set(rtk_DEVEL_PREFIX "")
  set(rtk_INSTALL_PREFIX /home/skbt/BIT-UAV/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rtk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/skbt/BIT-UAV/src/location/rtk/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/skbt/BIT-UAV/devel/lib;/opt/ros/noetic/lib)
